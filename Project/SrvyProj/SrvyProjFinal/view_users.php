...
// Define the query:
$q = "SELECT email, last_name, first_name, password,  id_user FROM users ORDER BY $order_by LIMIT $start, $display";		
...
<tr>
	...
	<td align="left"><b><a href="view_users.php?sort=fn">Email</a></b></td>
	...
	<td align="left"><b><a href="view_users.php?sort=fn">Password</a></b></td>
</tr>
';
...
while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
	$bg = ($bg=='#eeeeee' ? '#ffffff' : '#eeeeee');
		echo '<tr bgcolor="' . $bg . '">
		<td align="left"><a href="edit_user.php?id_user=' . $row['id_user'] . '">Edit</a></td>
		<td align="left"><a href="delete_user.php?id_user=' . $row['id_user'] . '">Delete</a></td>
